export const allMessages = {
    ...
    "P2P.NoAutoSyncPeers": {
        ...
        ja: "自動同期ピアが見つかりません。ピアツーピア同期 (試験機能)ペインでピアを設定してください。",
    ...
    "Ui.SetupWizard.SelectExisting.ManualOptionDesc": {
        ...
        ja: "他の端末と同じサーバー情報を手動で再設定します。上級者向けの方法です。",
    ...
    "Ui.SetupWizard.SelectNew.ManualOptionDesc": {
        ...
        ja: "Setup URIがない場合や、詳細設定を手動で行いたい場合の上級者向けオプションです。",
    ...
    "Ui.SetupWizard.SelectNew.SetupUriOptionDesc": {
        ...
        ja: "Setup URIは、サーバーアドレスと認証情報を含む1本の文字列です。サーバーのインストールスクリプトで生成されたものがある場合、簡単かつ安全に設定できます。",
    ...
    "Ui.SetupWizard.SetupRemote.BucketOptionDesc": {
        ...
        ja: "ジャーナルファイルを利用する同期方式です。S3/MinIO/R2互換のオブジェクトストレージサービスを事前に設定しておく必要があります。",
